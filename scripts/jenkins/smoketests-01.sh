...
# Error creating shaded jar: duplicate entry: META-INF/services/com.atatus.apm.agent.shaded.stagemonitor.configuration.ConfigurationOptionProvider
./mvnw -pl atatus-apm-agent,apm-agent-attach clean
