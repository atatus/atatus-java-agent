...
class ApmSpan implements Span {
    ...
    @Nullable
    // com.atatus.apm.agent.impl.transaction.AbstractSpan in case of unfinished spans
    ...
    private Object getTraceContext(@Nullable Object dispatcher) {
        // com.atatus.apm.agent.opentracing.impl.ApmSpanInstrumentation$GetTraceContextInstrumentation
        return null;
    }
    ...
    public ApmSpan setOperationName(String operationName) {
        // com.atatus.apm.agent.opentracing.impl.ApmSpanInstrumentation$SetOperationName
        return this;
    }
    ...
    private void finishInternal(long finishMicros, Object traceContext) {
        // implementation injected at runtime by com.atatus.apm.agent.opentracing.impl.ApmSpanInstrumentation.FinishInstrumentation.finishInternal
    }
    ...
    public ApmSpan log(long timestampMicroseconds, Map<String, ?> fields) {
        // com.atatus.apm.agent.opentracing.impl.ApmSpanInstrumentation.LogInstrumentation
        return this;
    }
    ...
    private void handleTag(String key, @Nullable Object value) {
        // implementation injected at runtime by com.atatus.apm.agent.opentracing.impl.ApmSpanInstrumentation.TagInstrumentation.handleTag
    }
