...
class ExternalProcessSpanContext implements ApmSpanContext {
    ...
    // com.atatus.apm.agent.impl.transaction.TraceContext - only for the purpose of holding the parsed IDs
    @Nullable
    ...
    public String toTraceId() {
        // com.atatus.apm.agent.opentracing.impl.ExternalSpanContextInstrumentation$ToTraceIdInstrumentation
        return "";
    }

    @Override
    public String toSpanId() {
        // com.atatus.apm.agent.opentracing.impl.ExternalSpanContextInstrumentation$ToSpanIdInstrumentation
        return "";
    }
