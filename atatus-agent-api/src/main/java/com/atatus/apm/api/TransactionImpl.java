...
class TransactionImpl extends AbstractSpanImpl implements Transaction {
    ...
    public Transaction addCustomContext(String key, String value) {
        // com.atatus.apm.agent.plugin.api.TransactionInstrumentation$AddCustomContextInstrumentation
        return this;
    }
    ...
    public Transaction setUser(String id, String email, String username) {
        // com.atatus.apm.agent.plugin.api.TransactionInstrumentation$SetUserInstrumentation.setUser
        return this;
    }

    @Override
    public Transaction setResult(String result) {
        // com.atatus.apm.agent.plugin.api.TransactionInstrumentation.SetResultInstrumentation
        return this;
    }
    ...
    public String ensureParentId() {
        // com.atatus.apm.agent.plugin.api.TransactionInstrumentation.EnsureParentIdInstrumentation
        return "";
    }
