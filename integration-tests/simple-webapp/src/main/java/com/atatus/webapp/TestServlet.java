...
import static com.atatus.webapp.Constants.CAUSE_DB_ERROR;
import static com.atatus.webapp.Constants.CAUSE_TRANSACTION_ERROR;
import static com.atatus.webapp.Constants.DB_ERROR;
import static com.atatus.webapp.Constants.TRANSACTION_FAILURE;
...
public class TestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException {
        ...
        if (!Atatus.currentTransaction().isSampled()) {
            throw new IllegalStateException("Current transaction is not sampled: " + Atatus.currentTransaction());
        }
