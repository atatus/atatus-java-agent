...
import com.atatus.apm.agent.bci.bytebuddy.ErrorLoggingListener;
import com.atatus.apm.agent.bci.bytebuddy.FailSafeDeclaredMethodsCompiler;
import com.atatus.apm.agent.bci.bytebuddy.MatcherTimer;
import com.atatus.apm.agent.bci.bytebuddy.MinimumClassFileVersionValidator;
import com.atatus.apm.agent.bci.bytebuddy.RootPackageCustomLocator;
import com.atatus.apm.agent.bci.bytebuddy.SimpleMethodSignatureOffsetMappingFactory;
import com.atatus.apm.agent.bci.bytebuddy.SoftlyReferencingTypePoolCache;
...
import static com.atatus.apm.agent.bci.bytebuddy.ClassLoaderNameMatcher.classLoaderWithName;
import static com.atatus.apm.agent.bci.bytebuddy.ClassLoaderNameMatcher.isReflectionClassLoader;
...
public class ElasticApmAgent {
    ...
    private static AgentBuilder getAgentBuilder(final ByteBuddy byteBuddy, final CoreConfiguration coreConfiguration, Logger logger) {
        ...
        return new AgentBuilder.Default(byteBuddy)
            ...
            .or(nameStartsWith("com.atatus.apm.agent.shaded"))
