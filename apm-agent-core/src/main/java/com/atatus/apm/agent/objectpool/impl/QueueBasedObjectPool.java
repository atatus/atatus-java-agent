 ...
 * #L%
 */
package com.atatus.apm.agent.objectpool.impl;
...
public class QueueBasedObjectPool<T> extends com.atatus.apm.agent.objectpool.impl.AbstractObjectPool<T> implements Collection<T> {

    private final Queue<T> queue;
    private final com.atatus.apm.agent.objectpool.impl.Resetter<T> resetter;
    ...
    public static <T extends Recyclable> QueueBasedObjectPool<T> ofRecyclable(Queue<T> queue, boolean preAllocate, Allocator<T> allocator) {
        return new QueueBasedObjectPool<>(queue, preAllocate, allocator, com.atatus.apm.agent.objectpool.impl.Resetter.ForRecyclable.<T>get());
    }

    public static <T> QueueBasedObjectPool<T> of(Queue<T> queue, boolean preAllocate, Allocator<T> allocator, com.atatus.apm.agent.objectpool.impl.Resetter<T> resetter) {
        return new QueueBasedObjectPool<>(queue, preAllocate, allocator, resetter);
    }

    private QueueBasedObjectPool(Queue<T> queue, boolean preAllocate, Allocator<T> allocator, com.atatus.apm.agent.objectpool.impl.Resetter<T> resetter) {
        super(allocator);
        this.queue = queue;
