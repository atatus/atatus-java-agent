 ...
 * {@link AtatusApmTracer#getActive()}.
 * <p>
 ...
 * so that {@link AtatusApmTracer#getActive()} returns the expected {@link TraceContextHolder}.
 * </p>
 * <p>
 * Note: {@link #close() closing} a scope does not {@link com.atatus.apm.agent.impl.transaction.AbstractSpan#end() end} it's active
 * {@link com.atatus.apm.agent.impl.transaction.AbstractSpan}.
 * </p>
 */
