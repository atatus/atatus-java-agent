 ...
 * #L%
 */
package com.atatus.apm.agent.logging;
...
public class LoggingConfiguration extends ConfigurationOptionProvider {
    ...
    private static void setLogLevel(@Nullable String level) {
        System.setProperty(SimpleLogger.LOG_KEY_PREFIX + "com.atatus.apm", level != null ? level : Level.INFO.toString());
        System.setProperty(SimpleLogger.LOG_KEY_PREFIX + "com.atatus.apm.agent.shaded", Level.WARN.toString());
