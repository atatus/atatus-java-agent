...
public class ErrorRequestPayload extends Payload {
	...
	public ErrorRequestPayload(Transaction transaction, String frameworkName) {
		this.name = transaction.getNameAsString();
		this.type = frameworkName;
		this.requestPayload = new RequestPayload(transaction.getContext().getRequest(),
