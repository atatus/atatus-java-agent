...
class HelperClassManagerTest {
    static {
        try {
            HelperClassManager.injectClass(HelperClassManagerTest.class.getClassLoader().getParent(), null,
                "com.atatus.apm.agent.bci.HelperClassManagerTest$InnerTestClass$HelperClassInterface", false);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    void testFailOnlyOnceAnyClassLoader() throws ClassNotFoundException {
        ...
        Class libClass1 = targetClassLoader1.loadClass("com.atatus.apm.agent.bci.HelperClassManagerTest$InnerTestClass$LibClass");
        ...
        Class libClass2 = targetClassLoader2.loadClass("com.atatus.apm.agent.bci.HelperClassManagerTest$InnerTestClass$LibClass");
    ...
    void testCaching() throws ClassNotFoundException, InterruptedException {
        ...
        Class libClass3 = targetClassLoader3.loadClass("com.atatus.apm.agent.bci.HelperClassManagerTest$InnerTestClass$LibClass");
