...
import static com.atatus.apm.agent.matcher.WildcardMatcher.caseSensitiveMatcher;
...
class MethodMatcherTest {
    ...
    void testMethodMatcherWithoutMethod() {
        final MethodMatcher methodMatcher = MethodMatcher.of("com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest");
        assertThat(methodMatcher).isNotNull();
        assertThat(methodMatcher.getClassMatcher().getMatcher()).isEqualTo("com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest");
    ...
    void testMethodMatcherWithoutArguments() {
        final MethodMatcher methodMatcher = MethodMatcher.of("com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest#testMethodMatcher");
        assertThat(methodMatcher).isNotNull();
        assertThat(methodMatcher.getClassMatcher().getMatcher()).isEqualTo("com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest");
    ...
    void testMethodMatcherNoArguments() {
        final MethodMatcher methodMatcher = MethodMatcher.of("public com.atatus.apm.agent.bci.methodmatching.Method*Test#testMethodMatcher()");
        assertThat(methodMatcher).isNotNull();
        assertThat(methodMatcher.getClassMatcher().getMatcher()).isEqualTo("com.atatus.apm.agent.bci.methodmatching.Method*Test");
        assertThat(methodMatcher.getMethodMatcher().getMatcher()).isEqualTo("testMethodMatcher");
    ...
    void testMethodMatcherOneArg() {
        final MethodMatcher methodMatcher = MethodMatcher.of("private com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest#test*Matcher(java.lang.String)");
        assertThat(methodMatcher).isNotNull();
        assertThat(methodMatcher.getClassMatcher().getMatcher()).isEqualTo("com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest");
    ...
    void testMethodMatcherTwoArgs() {
        final MethodMatcher methodMatcher = MethodMatcher.of("protected com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest#testMethodMatcher(*String, foo)");
        assertThat(methodMatcher).isNotNull();
        assertThat(methodMatcher.getClassMatcher().getMatcher()).isEqualTo("com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest");
        assertThat(methodMatcher.getMethodMatcher().getMatcher()).isEqualTo("testMethodMatcher");
    ...
    void testMethodMatcherThreeArgs() {
        final MethodMatcher methodMatcher = MethodMatcher.of("* com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest#testMethodMatcher(java.lang.String, foo,bar)");
        assertThat(methodMatcher).isNotNull();
        assertThat(methodMatcher.getClassMatcher().getMatcher()).isEqualTo("com.atatus.apm.agent.bci.methodmatching.MethodMatcherTest");
        assertThat(methodMatcher.getMethodMatcher().getMatcher()).isEqualTo("testMethodMatcher");
