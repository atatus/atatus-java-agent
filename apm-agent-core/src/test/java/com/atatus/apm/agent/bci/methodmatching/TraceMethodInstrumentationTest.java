...
class TraceMethodInstrumentationTest {
    ...
    void setUp(TestInfo testInfo) {
        ...
        when(coreConfiguration.getTraceMethods()).thenReturn(Arrays.asList(
            MethodMatcher.of("private com.atatus.apm.agent.bci.methodmatching.TraceMethodInstrumentationTest$TestClass#traceMe*()"),
            MethodMatcher.of("private com.atatus.apm.agent.bci.methodmatching.TraceMethodInstrumentationTest$TestDiscardableMethods#*"),
            MethodMatcher.of("private com.atatus.apm.agent.bci.methodmatching.TraceMethodInstrumentationTest$TestErrorCapture#*"),
            MethodMatcher.of("com.atatus.apm.agent.bci.methodmatching.TraceMethodInstrumentationTest$TestExcludeConstructor#*"),
            MethodMatcher.of("public @com.atatus.apm.agent.bci.methodmatching.TraceMethodInstrumentationTest$CustomAnnotation com.atatus.apm.agent.bci.methodmatching*"),
            MethodMatcher.of("public @@com.atatus.apm.agent.bci.methodmatching.TraceMethodInstrumentationTest$Meta* com.atatus.apm.agent.bci.methodmatching*"))
        );
