...
import static com.atatus.apm.agent.bci.bytebuddy.CustomElementMatchers.overridesOrImplementsMethodThat;
import static com.atatus.apm.agent.impl.transaction.AbstractSpan.PRIO_HIGH_LEVEL_FRAMEWORK;
...
public class JaxWsTransactionNameInstrumentation extends AtatusApmInstrumentation {

    private final Collection<String> applicationPackages;

    public JaxWsTransactionNameInstrumentation(AtatusApmTracer tracer) {
