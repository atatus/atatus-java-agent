...
public class ApacheHttpAsyncClientInstrumentation extends AtatusApmInstrumentation {
    ...
    public ApacheHttpAsyncClientInstrumentation(AtatusApmTracer tracer) {
        helperManager = HelperClassManager.ForAnyClassLoader.of(tracer,
            ...
            "com.atatus.apm.agent.httpclient.ApacheHttpAsyncClientHelperImpl$RequestProducerWrapperAllocator",
            "com.atatus.apm.agent.httpclient.FutureCallbackWrapper",
            "com.atatus.apm.agent.httpclient.ApacheHttpAsyncClientHelperImpl$FutureCallbackWrapperAllocator");
    }
