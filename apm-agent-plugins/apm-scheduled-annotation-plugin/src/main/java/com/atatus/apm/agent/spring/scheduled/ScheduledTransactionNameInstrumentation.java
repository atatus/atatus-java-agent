 ...
 * #L%
 */
package com.atatus.apm.agent.spring.scheduled;
...
public class ScheduledTransactionNameInstrumentation extends AtatusApmInstrumentation {
    ...
    public ScheduledTransactionNameInstrumentation(AtatusApmTracer tracer) {
