 ...
 * #L%
 */
package com.atatus.apm.agent.urlconnection;
...
import com.atatus.apm.agent.util.DataStructures;
...
public abstract class HttpUrlConnectionInstrumentation extends AtatusApmInstrumentation {
