...
public class CaptureTransactionInstrumentation extends AtatusApmInstrumentation {
    ...
    public static void onMethodEnter(@Advice.Origin Class<?> clazz,
                                     ...
                                     @AnnotationValueExtractor(annotationClassName = "com.atatus.apm.api.CaptureTransaction", method = "value") String transactionName,
                                     @AnnotationValueExtractor(annotationClassName = "com.atatus.apm.api.CaptureTransaction", method = "type") String type,
    ...
    public ElementMatcher.Junction<ClassLoader> getClassLoaderMatcher() {
        return classLoaderCanLoadClass("com.atatus.apm.api.CaptureTransaction");
    }
    ...
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        return isAnnotatedWith(named("com.atatus.apm.api.CaptureTransaction"));
    }
