...
public class CaptureSpanInstrumentation extends AtatusApmInstrumentation {
    ...
    public static void onMethodEnter(
        ...
        @AnnotationValueOffsetMappingFactory.AnnotationValueExtractor(annotationClassName = "com.atatus.apm.api.CaptureSpan", method = "value") String spanName,
        @AnnotationValueOffsetMappingFactory.AnnotationValueExtractor(annotationClassName = "com.atatus.apm.api.CaptureSpan", method = "type") String type,
        @Nullable @AnnotationValueOffsetMappingFactory.AnnotationValueExtractor(annotationClassName = "com.atatus.apm.api.CaptureSpan", method = "subtype") String subtype,
        @Nullable @AnnotationValueOffsetMappingFactory.AnnotationValueExtractor(annotationClassName = "com.atatus.apm.api.CaptureSpan", method = "action") String action,
    ...
    public ElementMatcher.Junction<ClassLoader> getClassLoaderMatcher() {
        return classLoaderCanLoadClass("com.atatus.apm.api.CaptureSpan");
    }
    ...
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        return isAnnotatedWith(named("com.atatus.apm.api.CaptureSpan"));
    }
