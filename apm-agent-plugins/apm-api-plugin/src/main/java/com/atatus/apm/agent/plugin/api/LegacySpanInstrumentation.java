...
/**
 * Injects the actual implementation of the public API class com.atatus.apm.api.SpanImpl.
 * <p>
...
public class LegacySpanInstrumentation extends ApiInstrumentation {
    ...
    public ElementMatcher<? super TypeDescription> getTypeMatcher() {
        return named("com.atatus.apm.api.SpanImpl").and(not(hasSuperType(named("com.atatus.apm.api.AbstractSpanImpl"))));
    }
