...
public class ExecutorServiceDoubleWrappingTest extends AbstractInstrumentationTest {
    ...
    private void createAsyncSpan() {
        ...
        for (StackTraceElement stackTraceElement : stackTrace) {
            if (stackTraceElement.getClassName().equals("com.atatus.apm.agent.impl.async.SpanInScopeRunnableWrapper") &&
                stackTraceElement.getMethodName().equals("run")) {
                numWrappers++;
            } else if (stackTraceElement.getClassName().equals("com.atatus.apm.agent.impl.async.SpanInScopeCallableWrapper") &&
