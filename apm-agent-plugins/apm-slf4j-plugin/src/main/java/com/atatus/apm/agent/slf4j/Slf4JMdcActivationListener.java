 ...
 * #L%
 */
package com.atatus.apm.agent.slf4j;
...
public class Slf4JMdcActivationListener implements ActivationListener {
    ...
    // the string concatenation prevents the shade plugin from relocating org.slf4j.MDC to com.atatus.apm.agent.shaded.slf4j.MDC
