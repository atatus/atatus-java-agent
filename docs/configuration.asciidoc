...
----
boot_delegation_packages=com.sun.*, javax.transaction, javax.transaction.*, javax.xml.crypto, javax.xml.crypto.*, sun.*,com.atatus.apm.agent.*
----

Pentaho and RedHat JBoss Fuse:

----
boot_delegation_packages=org.apache.karaf.jaas.boot, org.apache.karaf.jaas.boot.principal, org.apache.karaf.management.boot, sun.*, com.sun.*, javax.transaction, javax.transaction.*, javax.xml.crypto, javax.xml.crypto.*, org.apache.xerces.jaxp.datatype, org.apache.xerces.stax, org.apache.xerces.parsers, org.apache.xerces.jaxp, org.apache.xerces.jaxp.validation, org.apache.xerces.dom, com.atatus.apm.agent.*
----
...
|============
| Default                          | Type                | Dynamic
| `com.atatus.apm.agent.*` | String | false
|============
...
# This setting can not be changed at runtime. Changes require a restart of the application.
# Type: String
# Default value: com.atatus.apm.agent.*
#
# boot_delegation_packages=com.atatus.apm.agent.*
