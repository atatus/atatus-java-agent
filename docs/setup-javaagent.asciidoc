...
link:https://search.maven.org/search?q=g:co.elastic.apm%20AND%20a:atatus-apm-agent[maven central].
...
==== Add `javaagent` flag
When starting your application, add the JVM flag `-javaagent:/path/to/atatus-apm-agent-<version>.jar`
...
[source,bash]
----
java -javaagent:/path/to/atatus-apm-agent-<version>.jar -Delastic.apm.service_name=my-cool-service -Delastic.apm.application_packages=org.example,org.another.example -Delastic.apm.server_urls=http://localhost:8200 -jar my-application.jar
----
...
.setenv.sh
----
export CATALINA_OPTS="$CATALINA_OPTS -javaagent:/path/to/atatus-apm-agent-<version>.jar"
...
.setenv.bat
----
set CATALINA_OPTS=%CATALINA_OPTS% -javaagent:C:/path/to/atatus-apm-agent-<version>.jar
...
.jetty.sh
----
export JAVA_OPTIONS="${JAVA_OPTIONS} -javaagent:/path/to/atatus-apm-agent-<version>.jar"
...
----
--exec
-javaagent:/path/to/atatus-apm-agent-<version>.jar
...
.bin/standalone.conf
----
export JAVA_OPTS="$JAVA_OPTS -javaagent:/path/to/atatus-apm-agent-<version>.jar"
...
----
set JAVA_OPTS=%JAVA_OPTS% -javaagent:C:/path/to/atatus-apm-agent-<version>.jar
...
<server-group>
  <jvm>
     <jvm-options>
      ...
      <option value="-javaagent:/path/to/atatus-apm-agent-<version>.jar"/>
      ...
     </jvm-options>
  </jvm>
</server-group>
...
<java-config>
  ...
  <jvm-options>-javaagent:/path/to/atatus-apm-agent-<version>.jar</jvm-options>
...
----
set JAVA_OPTIONS=%JAVA_OPTIONS% -javaagent:C:/path/to/atatus-apm-agent-<version>.jar
